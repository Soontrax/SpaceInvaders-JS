function nivel2() {
    ...
    var PLAYER_MAX_SPEED = 900;

    var LASER_MAX_SPEED = 800;
    ...
    function updateGAME() {
        ...
        if (GAME_STATE.gameOver) {
            ...
            document.cookie = "Enemigos muertos2 = " + contador_enemigos;
            document.cookie = "Minutos aguantados2 = " + contador_min;
            document.cookie = "Segundos aguantados2 = " + contador_seg;
            audioMenu.pause();
...
//We create a variable global for check the music of how should stop or continued
const audioMenu = new Audio();
audioMenu.src = "audio/music.mp3";
audioMenu.play();

//We check if the user are in the corners of the div
function rectsIntersect(r1, r2) {
    return !(r2.left > r1.right ||
        r2.right < r1.left ||
        r2.top > r1.bottom ||
...
function updateGAME() {
    ...
    if (GAME_STATE.gameOver) {
        ...
        audioMenu.pause();
        clearInterval(tiempo);
        //If the user loses we create cookies of the resullt of the party
        document.cookie = "Enemigos muertos = " + contador_enemigos;
        document.cookie = "Minutos aguantados = " + contador_min;
        document.cookie = "Segundos aguantados = " + contador_seg;
        return;
    }
...
//I listening the keys if the user are pressing any keys of movement
window.addEventListener("keydown", onKeyDown);
window.addEventListener("keyup", onKeyUp);
window.requestAnimationFrame(updateGAME);